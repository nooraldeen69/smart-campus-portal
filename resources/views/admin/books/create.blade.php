        ...
        <form method="POST" action="{{ route('admin.books.store') }}">
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-4">
                    ...
                    <input type="number" id="available_copies" name="available_copies" min="0" class="form-control" value="{{ old('available_copies', 1) }}" required>
                </div>
            </div>
            <button class="btn btn-primary"><i class="bi bi-check-circle me-1"></i>Add Book</button>
